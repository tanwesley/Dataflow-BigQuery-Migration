...
To write an update configuration JSON, write a BigQuery JSON schema containing only the JSON object columns that will be changed (added/deleted/modified) with the addition of additional fields: 
